// Path: Your-Garden-Eden-IOS/Core/Helpers/AppNavigationData.swift

import Foundation

struct AppNavigationData {

    static private func extractSlug(from link: String, prefixToRemoveIfProductList: String = "/product-list/") -> String {
    ...
    static let items: [AppNavigationItem] = [
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/gartenmoebel"), label: "Gartenmöbel", i18nId: "header.nav.furniture", imageFilename: "cat_banner_gartenmoebel",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/sonnenschutz"), label: "Sonnenschutz", i18nId: "header.nav.sunprotection", imageFilename: "cat_banner_sonnenschutz",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/wasser-im-garten"), label: "Wasser im Garten", i18nId: "header.nav.water", imageFilename: "cat_banner_wasser-im-garten",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/heizen-feuer"), label: "Heizen & Feuer", i18nId: "header.nav.heating", imageFilename: "cat_banner_heizen-feuer",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/gartenhelfer-aufbewahrung"), label: "Gartenhelfer", i18nId: "header.nav.gardenhelpers", imageFilename: "cat_banner_gartenhelfer",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/deko-licht"), label: "Deko & Licht", i18nId: "header.nav.deco", imageFilename: "cat_banner_deko-licht",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/pflanzen-anzucht"), label: "Pflanzen & Anzucht", i18nId: "header.nav.plants", imageFilename: "cat_banner_pflanzen-anzucht",
            subItems: [
        ...
        AppNavigationItem(
            mainCategorySlug: extractSlug(from: "/category/fuer-die-ganze-grossen"), label: "Spiel & Spaß", i18nId: "header.nav.playfun", imageFilename: "cat_banner_spiel-spass",
            subItems: [
